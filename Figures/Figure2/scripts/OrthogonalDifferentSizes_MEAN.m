...
lambda1 = LambdaGENERAL(n, q1, Lgths, W, 'orthogonal');
lambda2 = LambdaGENERAL(n, q2, Lgths, W, 'orthogonal');
...
for jj = 1:length(K)
 ...
 %% saving
 cd('path to the directory where results should be saved')
% 
 save FDR_005_MEAN_WEAK.txt -ascii FDR_005;
 save FDR_01_MEAN_WEAK.txt -ascii FDR_01;
 save POWER_005_MEAN_WEAK.txt -ascii POWER_005;
 save POWER_01_MEAN_WEAK.txt -ascii POWER_01;
 
 save stdFDR_005_MEAN_WEAK.txt -ascii stdFDR_005;
 save stdFDR_01_MEAN_WEAK.txt -ascii stdFDR_01;
 save stdPOWER_005_MEAN_WEAK.txt -ascii stdPOWER_005;
 save stdPOWER_01_MEAN_WEAK.txt -ascii stdPOWER_01;
 
 save PROP_TRUE_005_MEAN_WEAK.txt -ascii PROP_TRUE_005;
 save PROP_TRUE_01_MEAN_WEAK.txt -ascii PROP_TRUE_01;
 save PROP_FALSE_005_MEAN_WEAK.txt -ascii PROP_FALSE_005;
 save PROP_FALSE_01_MEAN_WEAK.txt -ascii PROP_FALSE_01;

...
path =" " #path to figure3
save_path =" " #path for the results directory
...
FDR        = rep(0, times= length(K));
POWER      = rep(0, times= length(K));
stdFDR     = rep(0, times= length(K));
stdPOWER   = rep(0, times= length(K));
LNGTHs     = rep(0, times= length(K));
LNGTHs_t   = rep(0, times= length(K));
LAMB       = rep(0, times= length(K));
